...
D3DXMATRIX*(WINAPI* original_D3DXMatrixMultiply)(D3DXMATRIX* pOut,
...
BOOL init()
{
	...
	g_d3dx9_module = LoadLibraryW(d3d9x_path.c_str());
	...
	//// オリジナルの関数ポインタを取得
	original_D3DXAssembleShader = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcData, UINT SrcDataLen, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXAssembleShader"));
	original_D3DXAssembleShaderFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXAssembleShaderFromFileA"));
	original_D3DXAssembleShaderFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXAssembleShaderFromFileW"));
	original_D3DXAssembleShaderFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXAssembleShaderFromResourceA"));
	original_D3DXAssembleShaderFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXAssembleShaderFromResourceW"));
	original_D3DXBoxBoundProbe = reinterpret_cast<BOOL(WINAPI*)(CONST D3DXVECTOR3 * pMin, CONST D3DXVECTOR3 * pMax, CONST D3DXVECTOR3 * pRayPosition, CONST D3DXVECTOR3 * pRayDirection)>(GetProcAddress(g_d3dx9_module, "D3DXBoxBoundProbe"));
	original_D3DXCheckCubeTextureRequirements = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT * pSize, UINT * pNumMipLevels, DWORD Usage, D3DFORMAT * pFormat, D3DPOOL Pool)>(GetProcAddress(g_d3dx9_module, "D3DXCheckCubeTextureRequirements"));
	original_D3DXCheckTextureRequirements = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT * pWidth, UINT * pHeight, UINT * pNumMipLevels, DWORD Usage, D3DFORMAT * pFormat, D3DPOOL Pool)>(GetProcAddress(g_d3dx9_module, "D3DXCheckTextureRequirements"));
	original_D3DXCheckVersion = reinterpret_cast<BOOL(WINAPI*)(UINT D3DSdkVersion, UINT D3DXSdkVersion)>(GetProcAddress(g_d3dx9_module, "D3DXCheckVersion"));
	original_D3DXCheckVolumeTextureRequirements = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT * pWidth, UINT * pHeight, UINT * pDepth, UINT * pNumMipLevels, DWORD Usage, D3DFORMAT * pFormat, D3DPOOL Pool)>(GetProcAddress(g_d3dx9_module, "D3DXCheckVolumeTextureRequirements"));
	original_D3DXCleanMesh = reinterpret_cast<HRESULT(WINAPI*)(D3DXCLEANTYPE CleanType, LPD3DXMESH pMeshIn, CONST DWORD * pAdjacencyIn, LPD3DXMESH * ppMeshOut, DWORD * pAdjacencyOut, LPD3DXBUFFER * ppErrorsAndWarnings)>(GetProcAddress(g_d3dx9_module, "D3DXCleanMesh"));
	original_D3DXColorAdjustContrast = reinterpret_cast<D3DXCOLOR*(WINAPI*)(D3DXCOLOR * pOut, CONST D3DXCOLOR * pC, FLOAT c)>(GetProcAddress(g_d3dx9_module, "D3DXColorAdjustContrast"));
	original_D3DXColorAdjustSaturation = reinterpret_cast<D3DXCOLOR*(WINAPI*)(D3DXCOLOR * pOut, CONST D3DXCOLOR * pC, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXColorAdjustSaturation"));
	original_D3DXCompileShader = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcData, UINT SrcDataLen, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs, LPD3DXCONSTANTTABLE * ppConstantTable)>(GetProcAddress(g_d3dx9_module, "D3DXCompileShader"));
	original_D3DXCompileShaderFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs, LPD3DXCONSTANTTABLE * ppConstantTable)>(GetProcAddress(g_d3dx9_module, "D3DXCompileShaderFromFileA"));
	original_D3DXCompileShaderFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs, LPD3DXCONSTANTTABLE * ppConstantTable)>(GetProcAddress(g_d3dx9_module, "D3DXCompileShaderFromFileW"));
	original_D3DXCompileShaderFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs, LPD3DXCONSTANTTABLE * ppConstantTable)>(GetProcAddress(g_d3dx9_module, "D3DXCompileShaderFromResourceA"));
	original_D3DXCompileShaderFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pFunctionName, LPCSTR pProfile, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs, LPD3DXCONSTANTTABLE * ppConstantTable)>(GetProcAddress(g_d3dx9_module, "D3DXCompileShaderFromResourceW"));
	original_D3DXComputeBoundingBox = reinterpret_cast<HRESULT(WINAPI*)(CONST D3DXVECTOR3 * pFirstPosition, DWORD NumVertices, DWORD dwStride, D3DXVECTOR3 * pMin, D3DXVECTOR3 * pMax)>(GetProcAddress(g_d3dx9_module, "D3DXComputeBoundingBox"));
	original_D3DXComputeBoundingSphere = reinterpret_cast<HRESULT(WINAPI*)(CONST D3DXVECTOR3 * pFirstPosition, DWORD NumVertices, DWORD dwStride, D3DXVECTOR3 * pCenter, FLOAT * pRadius)>(GetProcAddress(g_d3dx9_module, "D3DXComputeBoundingSphere"));
	original_D3DXComputeIMTFromPerTexelSignal = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, DWORD dwTextureIndex, FLOAT * pfTexelSignal, UINT uWidth, UINT uHeight, UINT uSignalDimension, UINT uComponents, DWORD dwOptions, LPD3DXUVATLASCB pStatusCallback, LPVOID pUserContext, LPD3DXBUFFER * ppIMTData)>(GetProcAddress(g_d3dx9_module, "D3DXComputeIMTFromPerTexelSignal"));
	original_D3DXComputeIMTFromPerVertexSignal = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, CONST FLOAT * pfVertexSignal, UINT uSignalDimension, UINT uSignalStride, DWORD dwOptions, LPD3DXUVATLASCB pStatusCallback, LPVOID pUserContext, LPD3DXBUFFER * ppIMTData)>(GetProcAddress(g_d3dx9_module, "D3DXComputeIMTFromPerVertexSignal"));
	original_D3DXComputeIMTFromSignal = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, DWORD dwTextureIndex, UINT uSignalDimension, FLOAT fMaxUVDistance, DWORD dwOptions, LPD3DXIMTSIGNALCALLBACK pSignalCallback, VOID * pUserData, LPD3DXUVATLASCB pStatusCallback, LPVOID pUserContext, LPD3DXBUFFER * ppIMTData)>(GetProcAddress(g_d3dx9_module, "D3DXComputeIMTFromSignal("));
	original_D3DXComputeIMTFromTexture = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, LPDIRECT3DTEXTURE9 pTexture, DWORD dwTextureIndex, DWORD dwOptions, LPD3DXUVATLASCB pStatusCallback, LPVOID pUserContext, LPD3DXBUFFER * ppIMTData)>(GetProcAddress(g_d3dx9_module, "D3DXComputeIMTFromTexture"));
	original_D3DXComputeNormalMap = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DTEXTURE9 pTexture, LPDIRECT3DTEXTURE9 pSrcTexture, CONST PALETTEENTRY * pSrcPalette, DWORD Flags, DWORD Channel, FLOAT Amplitude)>(GetProcAddress(g_d3dx9_module, "D3DXComputeNormalMap"));
	original_D3DXComputeNormals = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBASEMESH pMesh, CONST DWORD * pAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXComputeNormals"));
	original_D3DXComputeTangentFrame = reinterpret_cast<HRESULT(WINAPI*)(ID3DXMesh * pMesh, DWORD dwOptions)>(GetProcAddress(g_d3dx9_module, "D3DXComputeTangentFrame"));
	original_D3DXComputeTangentFrame = reinterpret_cast<HRESULT(WINAPI*)(ID3DXMesh * pMesh, DWORD dwOptions)>(GetProcAddress(g_d3dx9_module, "D3DXComputeTangentFrame"));
	original_D3DXComputeTangentFrameEx = reinterpret_cast<HRESULT(WINAPI*)(ID3DXMesh * pMesh, DWORD dwTextureInSemantic, DWORD dwTextureInIndex, DWORD dwUPartialOutSemantic, DWORD dwUPartialOutIndex, DWORD dwVPartialOutSemantic, DWORD dwVPartialOutIndex, DWORD dwNormalOutSemantic, DWORD dwNormalOutIndex, DWORD dwOptions, CONST DWORD * pdwAdjacency, FLOAT fPartialEdgeThreshold, FLOAT fSingularPointThreshold, FLOAT fNormalEdgeThreshold, ID3DXMesh * *ppMeshOut, ID3DXBuffer * *ppVertexMapping)>(GetProcAddress(g_d3dx9_module, "D3DXComputeTangentFrameEx"));
	original_D3DXConcatenateMeshes = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH * ppMeshes, UINT NumMeshes, DWORD Options, CONST D3DXMATRIX * pGeomXForms, CONST D3DXMATRIX * pTextureXForms, CONST D3DVERTEXELEMENT9 * pDecl, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXMESH * ppMeshOut)>(GetProcAddress(g_d3dx9_module, "D3DXConcatenateMeshes"));
	original_D3DXConvertMeshSubsetToSingleStrip = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBASEMESH MeshIn, DWORD AttribId, DWORD IBOptions, LPDIRECT3DINDEXBUFFER9 * ppIndexBuffer, DWORD * pNumIndices)>(GetProcAddress(g_d3dx9_module, "D3DXConvertMeshSubsetToSingleStrip"));
	original_D3DXConvertMeshSubsetToStrips = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBASEMESH MeshIn, DWORD AttribId, DWORD IBOptions, LPDIRECT3DINDEXBUFFER9 * ppIndexBuffer, DWORD * pNumIndices, LPD3DXBUFFER * ppStripLengths, DWORD * pNumStrips)>(GetProcAddress(g_d3dx9_module, "D3DXConvertMeshSubsetToStrips"));
	original_D3DXCreateAnimationController = reinterpret_cast<HRESULT(WINAPI*)(UINT MaxNumMatrices, UINT MaxNumAnimationSets, UINT MaxNumTracks, UINT MaxNumEvents, LPD3DXANIMATIONCONTROLLER * ppAnimController)>(GetProcAddress(g_d3dx9_module, "D3DXCreateAnimationController"));
	original_D3DXCreateBox = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, FLOAT Width, FLOAT Height, FLOAT Depth, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXCreateBox"));
	original_D3DXCreateBuffer = reinterpret_cast<HRESULT(WINAPI*)(DWORD NumBytes, LPD3DXBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXCreateBuffer"));
	original_D3DXCreateCompressedAnimationSet = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pName, DOUBLE TicksPerSecond, D3DXPLAYBACK_TYPE Playback, LPD3DXBUFFER pCompressedData, UINT NumCallbackKeys, CONST D3DXKEY_CALLBACK * pCallbackKeys, LPD3DXCOMPRESSEDANIMATIONSET * ppAnimationSet)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCompressedAnimationSet"));
	original_D3DXCreateCubeTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT Size, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTexture"));
	original_D3DXCreateCubeTextureFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromFileA"));
	original_D3DXCreateCubeTextureFromFileExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, UINT Size, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromFileExA"));
	original_D3DXCreateCubeTextureFromFileExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, UINT Size, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromFileExW"));
	original_D3DXCreateCubeTextureFromFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataSize, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromFileInMemory"));
	original_D3DXCreateCubeTextureFromFileInMemoryEx = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataSize, UINT Size, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromFileInMemoryEx"));
	original_D3DXCreateCubeTextureFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromFileW"));
	original_D3DXCreateCubeTextureFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromResourceA"));
	original_D3DXCreateCubeTextureFromResourceExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, UINT Size, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromResourceExA"));
	original_D3DXCreateCubeTextureFromResourceExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, UINT Size, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromResourceExW"));
	original_D3DXCreateCubeTextureFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, LPDIRECT3DCUBETEXTURE9 * ppCubeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCubeTextureFromResourceW"));
	original_D3DXCreateCylinder = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, FLOAT Radius1, FLOAT Radius2, FLOAT Length, UINT Slices, UINT Stacks, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXCreateCylinder"));
	original_D3DXCreateEffect = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataLen, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffect"));
	original_D3DXCreateEffectCompiler = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcData, UINT SrcDataLen, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTCOMPILER * ppCompiler, LPD3DXBUFFER * ppParseErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectCompiler"));
	original_D3DXCreateEffectCompilerFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTCOMPILER * ppCompiler, LPD3DXBUFFER * ppParseErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectCompilerFromFileA"));
	original_D3DXCreateEffectCompilerFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTCOMPILER * ppCompiler, LPD3DXBUFFER * ppParseErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectCompilerFromFileW"));
	original_D3DXCreateEffectCompilerFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTCOMPILER * ppCompiler, LPD3DXBUFFER * ppParseErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectCompilerFromResourceA"));
	original_D3DXCreateEffectCompilerFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTCOMPILER * ppCompiler, LPD3DXBUFFER * ppParseErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectCompilerFromResourceW"));
	original_D3DXCreateEffectEx = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataLen, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pSkipConstants, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectEx"));
	original_D3DXCreateEffectFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromFileA"));
	original_D3DXCreateEffectFromFileExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pSkipConstants, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromFileExA"));
	original_D3DXCreateEffectFromFileExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pSkipConstants, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromFileExW"));
	original_D3DXCreateEffectFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromFileW"));
	original_D3DXCreateEffectFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromResourceA"));
	original_D3DXCreateEffectFromResourceExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pSkipConstants, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromResourceExA"));
	original_D3DXCreateEffectFromResourceExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPCSTR pSkipConstants, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromResourceExW"));
	original_D3DXCreateEffectFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXEFFECTPOOL pPool, LPD3DXEFFECT * ppEffect, LPD3DXBUFFER * ppCompilationErrors)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectFromResourceW"));
	original_D3DXCreateEffectPool = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXEFFECTPOOL * ppPool)>(GetProcAddress(g_d3dx9_module, "D3DXCreateEffectPool"));
	original_D3DXCreateFontA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, INT Height, UINT Width, UINT Weight, UINT MipLevels, BOOL Italic, DWORD CharSet, DWORD OutputPrecision, DWORD Quality, DWORD PitchAndFamily, LPCSTR pFaceName, LPD3DXFONT * ppFont)>(GetProcAddress(g_d3dx9_module, "D3DXCreateFontA"));
	original_D3DXCreateFontIndirectA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, CONST D3DXFONT_DESCA * pDesc, LPD3DXFONT * ppFont)>(GetProcAddress(g_d3dx9_module, "D3DXCreateFontIndirectA"));
	original_D3DXCreateFontIndirectW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, CONST D3DXFONT_DESCW * pDesc, LPD3DXFONT * ppFont)>(GetProcAddress(g_d3dx9_module, "D3DXCreateFontIndirectW"));
	original_D3DXCreateFontW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, INT Height, UINT Width, UINT Weight, UINT MipLevels, BOOL Italic, DWORD CharSet, DWORD OutputPrecision, DWORD Quality, DWORD PitchAndFamily, LPCWSTR pFaceName, LPD3DXFONT * ppFont)>(GetProcAddress(g_d3dx9_module, "D3DXCreateFontW"));
	// original_D3DXCreateFragmentLinker = reinterpret_cast<HRESULT  (WINAPI*)(  LPDIRECT3DDEVICE9      pDevice,   UINT       ShaderCacheSize,   LPD3DXFRAGMENTLINKER*  ppFragmentLinker)>(GetProcAddress(g_d3dx9_module, "D3DXCreateFragmentLinker"));
	original_D3DXCreateKeyframedAnimationSet = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pName, DOUBLE TicksPerSecond, D3DXPLAYBACK_TYPE Playback, UINT NumAnimations, UINT NumCallbackKeys, CONST D3DXKEY_CALLBACK * pCallbackKeys, LPD3DXKEYFRAMEDANIMATIONSET * ppAnimationSet)>(GetProcAddress(g_d3dx9_module, "D3DXCreateKeyframedAnimationSet"));
	original_D3DXCreateLine = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPD3DXLINE * ppLine)>(GetProcAddress(g_d3dx9_module, "D3DXCreateLine"));
	original_D3DXCreateMatrixStack = reinterpret_cast<HRESULT(WINAPI*)(DWORD Flags, LPD3DXMATRIXSTACK * ppStack)>(GetProcAddress(g_d3dx9_module, "D3DXCreateMatrixStack"));
	original_D3DXCreateMesh = reinterpret_cast<HRESULT(WINAPI*)(DWORD NumFaces, DWORD NumVertices, DWORD Options, CONST D3DVERTEXELEMENT9 * pDeclaration, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXCreateMesh"));
	original_D3DXCreateMeshFVF = reinterpret_cast<HRESULT(WINAPI*)(DWORD NumFaces, DWORD NumVertices, DWORD Options, DWORD FVF, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXCreateMeshFVF"));
	original_D3DXCreateNPatchMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMeshSysMem, LPD3DXPATCHMESH * pPatchMesh)>(GetProcAddress(g_d3dx9_module, "D3DXCreateNPatchMesh"));
	original_D3DXCreatePMeshFromStream = reinterpret_cast<HRESULT(WINAPI*)(IStream * pStream, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pNumMaterials, LPD3DXPMESH * ppPMesh)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePMeshFromStream"));
	original_D3DXCreatePRTBuffer = reinterpret_cast<HRESULT(WINAPI*)(UINT NumSamples, UINT NumCoeffs, UINT NumChannels, LPD3DXPRTBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePRTBuffer"));
	original_D3DXCreatePRTBufferTex = reinterpret_cast<HRESULT(WINAPI*)(UINT Width, UINT Height, UINT NumCoeffs, UINT NumChannels, LPD3DXPRTBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePRTBufferTex"));
	original_D3DXCreatePRTCompBuffer = reinterpret_cast<HRESULT(WINAPI*)(D3DXSHCOMPRESSQUALITYTYPE Quality, UINT NumClusters, UINT NumPCA, LPD3DXSHPRTSIMCB pCB, LPVOID lpUserContext, LPD3DXPRTBUFFER pBufferIn, LPD3DXPRTCOMPBUFFER * ppBufferOut)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePRTCompBuffer"));
	original_D3DXCreatePRTEngine = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, DWORD * pAdjacency, BOOL ExtractUVs, LPD3DXMESH pBlockerMesh, LPD3DXPRTENGINE * ppEngine)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePRTEngine"));
	original_D3DXCreatePatchMesh = reinterpret_cast<HRESULT(WINAPI*)(CONST D3DXPATCHINFO * pInfo, DWORD dwNumPatches, DWORD dwNumVertices, DWORD dwOptions, CONST D3DVERTEXELEMENT9 * pDecl, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXPATCHMESH * pPatchMesh)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePatchMesh"));
	original_D3DXCreatePolygon = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, FLOAT Length, UINT Sides, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXCreatePolygon"));
	original_D3DXCreateRenderToEnvMap = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT Size, UINT MipLevels, D3DFORMAT Format, BOOL DepthStencil, D3DFORMAT DepthStencilFormat, LPD3DXRenderToEnvMap * ppRenderToEnvMap)>(GetProcAddress(g_d3dx9_module, "D3DXCreateRenderToEnvMap"));
	original_D3DXCreateRenderToSurface = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT Width, UINT Height, D3DFORMAT Format, BOOL DepthStencil, D3DFORMAT DepthStencilFormat, LPD3DXRENDERTOSURFACE * ppRenderToSurface)>(GetProcAddress(g_d3dx9_module, "D3DXCreateRenderToSurface"));
	original_D3DXCreateSPMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, CONST DWORD * pAdjacency, CONST D3DXATTRIBUTEWEIGHTS * pVertexAttributeWeights, CONST FLOAT * pVertexWeights, LPD3DXSPMESH * ppSMesh)>(GetProcAddress(g_d3dx9_module, "D3DXCreateSPMesh"));
	original_D3DXCreateSkinInfo = reinterpret_cast<HRESULT(WINAPI*)(DWORD NumVertices, CONST D3DVERTEXELEMENT9 * pDeclaration, DWORD NumBones, LPD3DXSKININFO * ppSkinInfo)>(GetProcAddress(g_d3dx9_module, "D3DXCreateSkinInfo"));
	original_D3DXCreateSkinInfoFVF = reinterpret_cast<HRESULT(WINAPI*)(DWORD NumVertices, DWORD FVF, DWORD NumBones, LPD3DXSKININFO * ppSkinInfo)>(GetProcAddress(g_d3dx9_module, "D3DXCreateSkinInfoFVF"));
	original_D3DXCreateSkinInfoFromBlendedMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBASEMESH pMesh, DWORD NumBones, CONST D3DXBONECOMBINATION * pBoneCombinationTable, LPD3DXSKININFO * ppSkinInfo)>(GetProcAddress(g_d3dx9_module, "D3DXCreateSkinInfoFromBlendedMesh"));
	original_D3DXCreateSphere = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, FLOAT Radius, UINT Slices, UINT Stacks, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXCreateSphere"));
	original_D3DXCreateSprite = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPD3DXSPRITE * ppSprite)>(GetProcAddress(g_d3dx9_module, "D3DXCreateSprite"));
	original_D3DXCreateTeapot = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTeapot"));
	original_D3DXCreateTextA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HDC hDC, LPCSTR pText, FLOAT Deviation, FLOAT Extrusion, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency, LPGLYPHMETRICSFLOAT pGlyphMetrics)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextA"));
	original_D3DXCreateTextW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HDC hDC, LPCWSTR pText, FLOAT Deviation, FLOAT Extrusion, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency, LPGLYPHMETRICSFLOAT pGlyphMetrics)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextW"));
	original_D3DXCreateTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTexture"));
	original_D3DXCreateTextureFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromFileA"));
	original_D3DXCreateTextureFromFileExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromFileExA"));
	original_D3DXCreateTextureFromFileExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromFileExW"));
	original_D3DXCreateTextureFromFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataSize, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromFileInMemory"));
	original_D3DXCreateTextureFromFileInMemoryEx = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataSize, UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromFileInMemoryEx"));
	original_D3DXCreateTextureFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromFileW"));
	original_D3DXCreateTextureFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromResourceA"));
	original_D3DXCreateTextureFromResourceExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromResourceExA"));
	original_D3DXCreateTextureFromResourceExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, UINT Width, UINT Height, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromResourceExW"));
	original_D3DXCreateTextureFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, LPDIRECT3DTEXTURE9 * ppTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureFromResourceW"));
	original_D3DXCreateTextureGutterHelper = reinterpret_cast<HRESULT(WINAPI*)(UINT Width, UINT Height, LPD3DXMESH pMesh, FLOAT GutterSize, LPD3DXTEXTUREGUTTERHELPER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureGutterHelper"));
	original_D3DXCreateTextureShader = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pFunction, LPD3DXTEXTURESHADER * ppTextureShader)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTextureShader"));
	original_D3DXCreateTorus = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, FLOAT InnerRadius, FLOAT OuterRadius, UINT Sides, UINT Rings, LPD3DXMESH * ppMesh, LPD3DXBUFFER * ppAdjacency)>(GetProcAddress(g_d3dx9_module, "D3DXCreateTorus"));
	original_D3DXCreateVolumeTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, UINT Width, UINT Height, UINT Depth, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTexture"));
	original_D3DXCreateVolumeTextureFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromFileA"));
	original_D3DXCreateVolumeTextureFromFileExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCSTR pSrcFile, UINT Width, UINT Height, UINT Depth, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromFileExA"));
	original_D3DXCreateVolumeTextureFromFileExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, UINT Width, UINT Height, UINT Depth, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromFileExW"));
	original_D3DXCreateVolumeTextureFromFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataSize, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromFileInMemory"));
	original_D3DXCreateVolumeTextureFromFileInMemoryEx = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCVOID pSrcData, UINT SrcDataSize, UINT Width, UINT Height, UINT Depth, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromFileInMemoryEx"));
	original_D3DXCreateVolumeTextureFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, LPCWSTR pSrcFile, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromFileW"));
	original_D3DXCreateVolumeTextureFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromResourceA"));
	original_D3DXCreateVolumeTextureFromResourceExA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCSTR pSrcResource, UINT Width, UINT Height, UINT Depth, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromResourceExA"));
	original_D3DXCreateVolumeTextureFromResourceExW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, UINT Width, UINT Height, UINT Depth, UINT MipLevels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool, DWORD Filter, DWORD MipFilter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo, PALETTEENTRY * pPalette, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromResourceExW"));
	original_D3DXCreateVolumeTextureFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice, HMODULE hSrcModule, LPCWSTR pSrcResource, LPDIRECT3DVOLUMETEXTURE9 * ppVolumeTexture)>(GetProcAddress(g_d3dx9_module, "D3DXCreateVolumeTextureFromResourceW"));
	original_D3DXDebugMute = reinterpret_cast<BOOL(WINAPI*)(BOOL Mute)>(GetProcAddress(g_d3dx9_module, "D3DXDebugMute"));
	original_D3DXDeclaratorFromFVF = reinterpret_cast<HRESULT(WINAPI*)(DWORD FVF, D3DVERTEXELEMENT9 pDeclarator[MAX_FVF_DECL_SIZE])>(GetProcAddress(g_d3dx9_module, "D3DXDeclaratorFromFVF"));
	original_D3DXDisassembleEffect = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXEFFECT pEffect, BOOL EnableColorCode, LPD3DXBUFFER * ppDisassembly)>(GetProcAddress(g_d3dx9_module, "D3DXDisassembleEffect"));
	original_D3DXDisassembleShader = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pShader, BOOL EnableColorCode, LPCSTR pComments, LPD3DXBUFFER * ppDisassembly)>(GetProcAddress(g_d3dx9_module, "D3DXDisassembleShader"));
	original_D3DXFVFFromDeclarator = reinterpret_cast<HRESULT(WINAPI*)(CONST D3DVERTEXELEMENT9 * pDeclarator, DWORD * pFVF)>(GetProcAddress(g_d3dx9_module, "D3DXFVFFromDeclarator"));
	original_D3DXFillCubeTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DCUBETEXTURE9 pCubeTexture, LPD3DXFILL3D pFunction, LPVOID pData)>(GetProcAddress(g_d3dx9_module, "D3DXFillCubeTexture"));
	original_D3DXFillCubeTextureTX = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DCUBETEXTURE9 pCubeTexture, LPD3DXTEXTURESHADER pTextureShader)>(GetProcAddress(g_d3dx9_module, "D3DXFillCubeTextureTX"));
	original_D3DXFillTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DTEXTURE9 pTexture, LPD3DXFILL2D pFunction, LPVOID pData)>(GetProcAddress(g_d3dx9_module, "D3DXFillTexture"));
	original_D3DXFillTextureTX = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DTEXTURE9 pTexture, LPD3DXTEXTURESHADER pTextureShader)>(GetProcAddress(g_d3dx9_module, "D3DXFillTextureTX"));
	original_D3DXFillVolumeTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUMETEXTURE9 pVolumeTexture, LPD3DXFILL3D pFunction, LPVOID pData)>(GetProcAddress(g_d3dx9_module, "D3DXFillVolumeTexture"));
	original_D3DXFillVolumeTextureTX = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUMETEXTURE9 pVolumeTexture, LPD3DXTEXTURESHADER pTextureShader)>(GetProcAddress(g_d3dx9_module, "D3DXFillVolumeTextureTX"));
	original_D3DXFilterTexture = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DBASETEXTURE9 pBaseTexture, CONST PALETTEENTRY * pPalette, UINT SrcLevel, DWORD Filter)>(GetProcAddress(g_d3dx9_module, "D3DXFilterTexture"));
	original_D3DXFindShaderComment = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pFunction, DWORD FourCC, LPCVOID * ppData, UINT * pSizeInBytes)>(GetProcAddress(g_d3dx9_module, "D3DXFindShaderComment"));
	original_D3DXFloat16To32Array = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, CONST D3DXFLOAT16 * pIn, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXFloat16To32Array"));
	original_D3DXFloat32To16Array = reinterpret_cast<D3DXFLOAT16*(WINAPI*)(D3DXFLOAT16 * pOut, CONST FLOAT * pIn, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXFloat32To16Array"));
	original_D3DXFrameAppendChild = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXFRAME pFrameParent, CONST D3DXFRAME * pFrameChild)>(GetProcAddress(g_d3dx9_module, "D3DXFrameAppendChild"));
	original_D3DXFrameCalculateBoundingSphere = reinterpret_cast<HRESULT(WINAPI*)(CONST D3DXFRAME * pFrameRoot, LPD3DXVECTOR3 pObjectCenter, FLOAT * pObjectRadius)>(GetProcAddress(g_d3dx9_module, "D3DXFrameCalculateBoundingSphere"));
	original_D3DXFrameDestroy = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXFRAME pFrameRoot, LPD3DXALLOCATEHIERARCHY pAlloc)>(GetProcAddress(g_d3dx9_module, "D3DXFrameDestroy"));
	original_D3DXFrameFind = reinterpret_cast<LPD3DXFRAME(WINAPI*)(CONST D3DXFRAME * pFrameRoot, LPCSTR Name)>(GetProcAddress(g_d3dx9_module, "D3DXFrameFind"));
	original_D3DXFrameNumNamedMatrices = reinterpret_cast<UINT(WINAPI*)(CONST D3DXFRAME * pFrameRoot)>(GetProcAddress(g_d3dx9_module, "D3DXFrameNumNamedMatrices"));
	original_D3DXFrameRegisterNamedMatrices = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXFRAME pFrameRoot, LPD3DXANIMATIONCONTROLLER pAnimController)>(GetProcAddress(g_d3dx9_module, "D3DXFrameRegisterNamedMatrices"));
	original_D3DXFresnelTerm = reinterpret_cast<FLOAT(WINAPI*)(FLOAT CosTheta, FLOAT RefractionIndex)>(GetProcAddress(g_d3dx9_module, "D3DXFresnelTerm"));
	original_D3DXGatherFragments = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcData, UINT SrcDataLen, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXGatherFragments"));
	original_D3DXGatherFragmentsFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXGatherFragmentsFromFileA"));
	original_D3DXGatherFragmentsFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXGatherFragmentsFromFileW"));
	original_D3DXGatherFragmentsFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXGatherFragmentsFromResourceA"));
	original_D3DXGatherFragmentsFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, DWORD Flags, LPD3DXBUFFER * ppShader, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXGatherFragmentsFromResourceW"));
	original_D3DXGenerateOutputDecl = reinterpret_cast<HRESULT(WINAPI*)(D3DVERTEXELEMENT9 * pOutput, CONST D3DVERTEXELEMENT9 * pInput)>(GetProcAddress(g_d3dx9_module, "D3DXGenerateOutputDecl"));
	original_D3DXGeneratePMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, CONST DWORD * pAdjacency, CONST D3DXATTRIBUTEWEIGHTS * pVertexAttributeWeights, CONST FLOAT * pVertexWeights, DWORD MinValue, DWORD Options, LPD3DXPMESH * ppPMesh)>(GetProcAddress(g_d3dx9_module, "D3DXGeneratePMesh"));
	original_D3DXGetDeclLength = reinterpret_cast<UINT(WINAPI*)(CONST D3DVERTEXELEMENT9 * pDecl)>(GetProcAddress(g_d3dx9_module, "D3DXGetDeclLength"));
	original_D3DXGetDeclVertexSize = reinterpret_cast<UINT(WINAPI*)(CONST D3DVERTEXELEMENT9 * pDecl, DWORD Stream)>(GetProcAddress(g_d3dx9_module, "D3DXGetDeclVertexSize"));
	original_D3DXGetDriverLevel = reinterpret_cast<UINT(WINAPI*)(LPDIRECT3DDEVICE9 pDevice)>(GetProcAddress(g_d3dx9_module, "D3DXGetDriverLevel"));
	original_D3DXGetFVFVertexSize = reinterpret_cast<UINT(WINAPI*)(DWORD FVF)>(GetProcAddress(g_d3dx9_module, "D3DXGetFVFVertexSize"));
	original_D3DXGetImageInfoFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcFile, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXGetImageInfoFromFileA"));
	original_D3DXGetImageInfoFromFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPCVOID pSrcData, UINT SrcDataSize, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXGetImageInfoFromFileInMemory"));
	original_D3DXGetImageInfoFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pSrcFile, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXGetImageInfoFromFileW"));
	original_D3DXGetImageInfoFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCSTR pSrcResource, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXGetImageInfoFromResourceA"));
	original_D3DXGetImageInfoFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCWSTR pSrcResource, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXGetImageInfoFromResourceW"));
	original_D3DXGetPixelShaderProfile = reinterpret_cast<LPCSTR(WINAPI*)(LPDIRECT3DDEVICE9 pDevice)>(GetProcAddress(g_d3dx9_module, "D3DXGetPixelShaderProfile"));
	original_D3DXGetShaderConstantTable = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pFunction, LPD3DXCONSTANTTABLE * ppConstantTable)>(GetProcAddress(g_d3dx9_module, "D3DXGetShaderConstantTable"));
	original_D3DXGetShaderInputSemantics = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pFunction, D3DXSEMANTIC * pSemantics, UINT * pCount)>(GetProcAddress(g_d3dx9_module, "D3DXGetShaderInputSemantics"));
	original_D3DXGetShaderOutputSemantics = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pFunction, D3DXSEMANTIC * pSemantics, UINT * pCount)>(GetProcAddress(g_d3dx9_module, "D3DXGetShaderOutputSemantics"));
	original_D3DXGetShaderSamplers = reinterpret_cast<HRESULT(WINAPI*)(CONST DWORD * pFunction, LPCSTR * pSamplers, UINT * pCount)>(GetProcAddress(g_d3dx9_module, "D3DXGetShaderSamplers"));
	original_D3DXGetShaderSize = reinterpret_cast<UINT(WINAPI*)(CONST DWORD * pFunction)>(GetProcAddress(g_d3dx9_module, "D3DXGetShaderSize"));
	original_D3DXGetShaderVersion = reinterpret_cast<DWORD(WINAPI*)(CONST DWORD * pFunction)>(GetProcAddress(g_d3dx9_module, "D3DXGetShaderVersion"));
	original_D3DXGetVertexShaderProfile = reinterpret_cast<LPCSTR(WINAPI*)(LPDIRECT3DDEVICE9 pDevice)>(GetProcAddress(g_d3dx9_module, "D3DXGetVertexShaderProfile"));
	original_D3DXIntersect = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBASEMESH pMesh, CONST D3DXVECTOR3 * pRayPos, CONST D3DXVECTOR3 * pRayDir, BOOL * pHit, DWORD * pFaceIndex, FLOAT * pU, FLOAT * pV, FLOAT * pDist, LPD3DXBUFFER * ppAllHits, DWORD * pCountOfHits)>(GetProcAddress(g_d3dx9_module, "D3DXIntersect"));
	original_D3DXIntersectSubset = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBASEMESH pMesh, DWORD AttribId, CONST D3DXVECTOR3 * pRayPos, CONST D3DXVECTOR3 * pRayDir, BOOL * pHit, DWORD * pFaceIndex, FLOAT * pU, FLOAT * pV, FLOAT * pDist, LPD3DXBUFFER * ppAllHits, DWORD * pCountOfHits)>(GetProcAddress(g_d3dx9_module, "D3DXIntersectSubset"));
	original_D3DXIntersectTri = reinterpret_cast<BOOL(WINAPI*)(CONST D3DXVECTOR3 * p0, CONST D3DXVECTOR3 * p1, CONST D3DXVECTOR3 * p2, CONST D3DXVECTOR3 * pRayPos, CONST D3DXVECTOR3 * pRayDir, FLOAT * pU, FLOAT * pV, FLOAT * pDist)>(GetProcAddress(g_d3dx9_module, "D3DXIntersectTri "));
	original_D3DXLoadMeshFromXA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pFilename, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppAdjacency, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pNumMaterials, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshFromXA"));
	original_D3DXLoadMeshFromXInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPCVOID Memory, DWORD SizeOfMemory, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppAdjacency, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pNumMaterials, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshFromXInMemory"));
	original_D3DXLoadMeshFromXResource = reinterpret_cast<HRESULT(WINAPI*)(HMODULE Module, LPCSTR Name, LPCSTR Type, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppAdjacency, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pNumMaterials, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshFromXResource"));
	original_D3DXLoadMeshFromXW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pFilename, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppAdjacency, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pNumMaterials, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshFromXW"));
	original_D3DXLoadMeshFromXof = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXFILEDATA pxofMesh, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppAdjacency, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pNumMaterials, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshFromXof"));
	original_D3DXLoadMeshHierarchyFromXA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR Filename, DWORD MeshOptions, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXALLOCATEHIERARCHY pAlloc, LPD3DXLOADUSERDATA pUserDataLoader, LPD3DXFRAME * ppFrameHierarchy, LPD3DXANIMATIONCONTROLLER * ppAnimController)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshHierarchyFromXA"));
	original_D3DXLoadMeshHierarchyFromXInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPCVOID Memory, DWORD SizeOfMemory, DWORD MeshOptions, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXALLOCATEHIERARCHY pAlloc, LPD3DXLOADUSERDATA pUserDataLoader, LPD3DXFRAME * ppFrameHierarchy, LPD3DXANIMATIONCONTROLLER * ppAnimController)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshHierarchyFromXInMemory"));
	original_D3DXLoadMeshHierarchyFromXW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR Filename, DWORD MeshOptions, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXALLOCATEHIERARCHY pAlloc, LPD3DXLOADUSERDATA pUserDataLoader, LPD3DXFRAME * ppFrameHierarchy, LPD3DXANIMATIONCONTROLLER * ppAnimController)>(GetProcAddress(g_d3dx9_module, "D3DXLoadMeshHierarchyFromXW"));
	original_D3DXLoadPRTBufferFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pFilename, LPD3DXPRTBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXLoadPRTBufferFromFileA"));
	original_D3DXLoadPRTBufferFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pFilename, LPD3DXPRTBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXLoadPRTBufferFromFileW"));
	original_D3DXLoadPRTCompBufferFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pFilename, LPD3DXPRTCOMPBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXLoadPRTCompBufferFromFileA"));
	original_D3DXLoadPRTCompBufferFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pFilename, LPD3DXPRTCOMPBUFFER * ppBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXLoadPRTCompBufferFromFileW"));
	original_D3DXLoadPatchMeshFromXof = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXFILEDATA pXofObjMesh, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, PDWORD pNumMaterials, LPD3DXPATCHMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadPatchMeshFromXof"));
	original_D3DXLoadSkinMeshFromXof = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXFILEDATA pxofMesh, DWORD Options, LPDIRECT3DDEVICE9 pD3DDevice, LPD3DXBUFFER * ppAdjacency, LPD3DXBUFFER * ppMaterials, LPD3DXBUFFER * ppEffectInstances, DWORD * pMatOut, LPD3DXSKININFO * ppSkinInfo, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSkinMeshFromXof"));
	original_D3DXLoadSurfaceFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, LPCSTR pSrcFile, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromFileA"));
	original_D3DXLoadSurfaceFromFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, LPCVOID pSrcData, UINT SrcDataSize, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromFileInMemory"));
	original_D3DXLoadSurfaceFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, LPCWSTR pSrcFile, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromFileW"));
	original_D3DXLoadSurfaceFromMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, LPCVOID pSrcMemory, D3DFORMAT SrcFormat, UINT SrcPitch, CONST PALETTEENTRY * pSrcPalette, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromMemory"));
	original_D3DXLoadSurfaceFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, HMODULE hSrcModule, LPCSTR pSrcResource, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromResourceA"));
	original_D3DXLoadSurfaceFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, HMODULE hSrcModule, LPCWSTR pSrcResource, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromResourceW"));
	original_D3DXLoadSurfaceFromSurface = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DSURFACE9 pDestSurface, CONST PALETTEENTRY * pDestPalette, CONST RECT * pDestRect, LPDIRECT3DSURFACE9 pSrcSurface, CONST PALETTEENTRY * pSrcPalette, CONST RECT * pSrcRect, DWORD Filter, D3DCOLOR ColorKey)>(GetProcAddress(g_d3dx9_module, "D3DXLoadSurfaceFromSurface"));
	original_D3DXLoadVolumeFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, LPCSTR pSrcFile, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromFileA"));
	original_D3DXLoadVolumeFromFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, LPCVOID pSrcData, UINT SrcDataSize, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromFileInMemory"));
	original_D3DXLoadVolumeFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, LPCWSTR pSrcFile, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromFileW"));
	original_D3DXLoadVolumeFromMemory = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, LPCVOID pSrcMemory, D3DFORMAT SrcFormat, UINT SrcRowPitch, UINT SrcSlicePitch, CONST PALETTEENTRY * pSrcPalette, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromMemory"));
	original_D3DXLoadVolumeFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromResourceA"));
	original_D3DXLoadVolumeFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey, D3DXIMAGE_INFO * pSrcInfo)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromResourceW"));
	original_D3DXLoadVolumeFromVolume = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVOLUME9 pDestVolume, CONST PALETTEENTRY * pDestPalette, CONST D3DBOX * pDestBox, LPDIRECT3DVOLUME9 pSrcVolume, CONST PALETTEENTRY * pSrcPalette, CONST D3DBOX * pSrcBox, DWORD Filter, D3DCOLOR ColorKey)>(GetProcAddress(g_d3dx9_module, "D3DXLoadVolumeFromVolume"));
	original_D3DXMatrixAffineTransformation = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT Scaling, CONST D3DXVECTOR3 * pRotationCenter, CONST D3DXQUATERNION * pRotation, CONST D3DXVECTOR3 * pTranslation)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixAffineTransformation"));
	original_D3DXMatrixAffineTransformation2D = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT Scaling, CONST D3DXVECTOR2 * pRotationCenter, FLOAT Rotation, CONST D3DXVECTOR2 * pTranslation)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixAffineTransformation2D"));
	original_D3DXMatrixDecompose = reinterpret_cast<HRESULT(WINAPI*)(D3DXVECTOR3 * pOutScale, D3DXQUATERNION * pOutRotation, D3DXVECTOR3 * pOutTranslation, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixDecompose"));
	original_D3DXMatrixDeterminant = reinterpret_cast<FLOAT(WINAPI*)(CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixDeterminant"));
	original_D3DXMatrixInverse = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT * pDeterminant, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixInverse"));
	original_D3DXMatrixLookAtLH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXVECTOR3 * pEye, CONST D3DXVECTOR3 * pAt, CONST D3DXVECTOR3 * pUp)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixLookAtLH"));
	original_D3DXMatrixLookAtRH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXVECTOR3 * pEye, CONST D3DXVECTOR3 * pAt, CONST D3DXVECTOR3 * pUp)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixLookAtRH"));
	original_D3DXMatrixMultiply = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXMATRIX * pM1, CONST D3DXMATRIX * pM2)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixMultiply"));
	original_D3DXMatrixMultiplyTranspose = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXMATRIX * pM1, CONST D3DXMATRIX * pM2)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixMultiplyTranspose"));
	original_D3DXMatrixOrthoLH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT w, FLOAT h, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixOrthoLH"));
	original_D3DXMatrixOrthoOffCenterLH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT l, FLOAT r, FLOAT b, FLOAT t, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixOrthoOffCenterLH"));
	original_D3DXMatrixOrthoOffCenterRH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT l, FLOAT r, FLOAT b, FLOAT t, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixOrthoOffCenterRH"));
	original_D3DXMatrixOrthoRH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT w, FLOAT h, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixOrthoRH"));
	original_D3DXMatrixPerspectiveFovLH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT fovy, FLOAT Aspect, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixPerspectiveFovLH"));
	original_D3DXMatrixPerspectiveFovRH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT fovy, FLOAT Aspect, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixPerspectiveFovRH"));
	original_D3DXMatrixPerspectiveLH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT w, FLOAT h, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixPerspectiveLH"));
	original_D3DXMatrixPerspectiveOffCenterLH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT l, FLOAT r, FLOAT b, FLOAT t, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixPerspectiveOffCenterLH"));
	original_D3DXMatrixPerspectiveOffCenterRH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT l, FLOAT r, FLOAT b, FLOAT t, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixPerspectiveOffCenterRH"));
	original_D3DXMatrixPerspectiveRH = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT w, FLOAT h, FLOAT zn, FLOAT zf)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixPerspectiveRH"));
	original_D3DXMatrixReflect = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXPLANE * pPlane)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixReflect"));
	original_D3DXMatrixRotationAxis = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXVECTOR3 * pV, FLOAT Angle)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixRotationAxis"));
	original_D3DXMatrixRotationQuaternion = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXQUATERNION * pQ)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixRotationQuaternion"));
	original_D3DXMatrixRotationX = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT Angle)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixRotationX"));
	original_D3DXMatrixRotationY = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT Angle)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixRotationY"));
	original_D3DXMatrixRotationYawPitchRoll = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT Yaw, FLOAT Pitch, FLOAT Roll)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixRotationYawPitchRoll"));
	original_D3DXMatrixRotationZ = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT Angle)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixRotationZ"));
	original_D3DXMatrixScaling = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT sx, FLOAT sy, FLOAT sz)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixScaling"));
	original_D3DXMatrixShadow = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXVECTOR4 * pLight, CONST D3DXPLANE * pPlane)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixShadow"));
	original_D3DXMatrixTransformation = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXVECTOR3 * pScalingCenter, CONST D3DXQUATERNION * pScalingRotation, CONST D3DXVECTOR3 * pScaling, CONST D3DXVECTOR3 * pRotationCenter, CONST D3DXQUATERNION * pRotation, CONST D3DXVECTOR3 * pTranslation)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixTransformation"));
	original_D3DXMatrixTransformation2D = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXVECTOR2 * pScalingCenter, FLOAT ScalingRotation, CONST D3DXVECTOR2 * pScaling, CONST D3DXVECTOR2 * pRotationCenter, FLOAT Rotation, CONST D3DXVECTOR2 * pTranslation)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixTransformation2D"));
	original_D3DXMatrixTranslation = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, FLOAT x, FLOAT y, FLOAT z)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixTranslation"));
	original_D3DXMatrixTranspose = reinterpret_cast<D3DXMATRIX*(WINAPI*)(D3DXMATRIX * pOut, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXMatrixTranspose"));
	original_D3DXOptimizeFaces = reinterpret_cast<HRESULT(WINAPI*)(LPCVOID pbIndices, UINT cFaces, UINT cVertices, BOOL b32BitIndices, DWORD * pFaceRemap)>(GetProcAddress(g_d3dx9_module, "D3DXOptimizeFaces"));
	original_D3DXOptimizeVertices = reinterpret_cast<HRESULT(WINAPI*)(LPCVOID pbIndices, UINT cFaces, UINT cVertices, BOOL b32BitIndices, DWORD * pVertexRemap)>(GetProcAddress(g_d3dx9_module, "D3DXOptimizeVertices"));
	original_D3DXPlaneFromPointNormal = reinterpret_cast<D3DXPLANE*(WINAPI*)(D3DXPLANE * pOut, CONST D3DXVECTOR3 * pPoint, CONST D3DXVECTOR3 * pNormal)>(GetProcAddress(g_d3dx9_module, "D3DXPlaneFromPointNormal"));
	original_D3DXPlaneFromPoints = reinterpret_cast<D3DXPLANE*(WINAPI*)(D3DXPLANE * pOut, CONST D3DXVECTOR3 * pV1, CONST D3DXVECTOR3 * pV2, CONST D3DXVECTOR3 * pV3)>(GetProcAddress(g_d3dx9_module, "D3DXPlaneFromPoints"));
	original_D3DXPlaneIntersectLine = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXPLANE * pP, CONST D3DXVECTOR3 * pV1, CONST D3DXVECTOR3 * pV2)>(GetProcAddress(g_d3dx9_module, "D3DXPlaneIntersectLine"));
	original_D3DXPlaneNormalize = reinterpret_cast<D3DXPLANE*(WINAPI*)(D3DXPLANE * pOut, CONST D3DXPLANE * pP)>(GetProcAddress(g_d3dx9_module, "D3DXPlaneNormalize"));
	original_D3DXPlaneTransform = reinterpret_cast<D3DXPLANE*(WINAPI*)(D3DXPLANE * pOut, CONST D3DXPLANE * pP, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXPlaneTransform"));
	original_D3DXPlaneTransformArray = reinterpret_cast<D3DXPLANE*(WINAPI*)(D3DXPLANE * pOut, UINT OutStride, CONST D3DXPLANE * pP, UINT PStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXPlaneTransformArray"));
	original_D3DXPreprocessShader = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcData, UINT SrcDataSize, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPD3DXBUFFER * ppShaderText, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXPreprocessShader"));
	original_D3DXPreprocessShaderFromFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPD3DXBUFFER * ppShaderText, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXPreprocessShaderFromFileA"));
	original_D3DXPreprocessShaderFromFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pSrcFile, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPD3DXBUFFER * ppShaderText, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXPreprocessShaderFromFileW"));
	original_D3DXPreprocessShaderFromResourceA = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPD3DXBUFFER * ppShaderText, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXPreprocessShaderFromResourceA"));
	original_D3DXPreprocessShaderFromResourceW = reinterpret_cast<HRESULT(WINAPI*)(HMODULE hSrcModule, LPCWSTR pSrcResource, CONST D3DXMACRO * pDefines, LPD3DXINCLUDE pInclude, LPD3DXBUFFER * ppShaderText, LPD3DXBUFFER * ppErrorMsgs)>(GetProcAddress(g_d3dx9_module, "D3DXPreprocessShaderFromResourceW"));
	original_D3DXQuaternionBaryCentric = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ1, CONST D3DXQUATERNION * pQ2, CONST D3DXQUATERNION * pQ3, FLOAT f, FLOAT g)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionBaryCentric"));
	original_D3DXQuaternionExp = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionExp"));
	original_D3DXQuaternionInverse = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionInverse"));
	original_D3DXQuaternionLn = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionLn"));
	original_D3DXQuaternionMultiply = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ1, CONST D3DXQUATERNION * pQ2)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionMultiply"));
	original_D3DXQuaternionNormalize = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionNormalize"));
	original_D3DXQuaternionRotationAxis = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXVECTOR3 * pV, FLOAT Angle)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionRotationAxis"));
	original_D3DXQuaternionRotationMatrix = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionRotationMatrix"));
	original_D3DXQuaternionRotationYawPitchRoll = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, FLOAT Yaw, FLOAT Pitch, FLOAT Roll)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionRotationYawPitchRoll"));
	original_D3DXQuaternionSlerp = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ1, CONST D3DXQUATERNION * pQ2, FLOAT t)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionSlerp"));
	original_D3DXQuaternionSquad = reinterpret_cast<D3DXQUATERNION*(WINAPI*)(D3DXQUATERNION * pOut, CONST D3DXQUATERNION * pQ1, CONST D3DXQUATERNION * pA, CONST D3DXQUATERNION * pB, CONST D3DXQUATERNION * pC, FLOAT t)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionSquad"));
	original_D3DXQuaternionSquadSetup = reinterpret_cast<void(WINAPI*)(D3DXQUATERNION * pAOut, D3DXQUATERNION * pBOut, D3DXQUATERNION * pCOut, CONST D3DXQUATERNION * pQ0, CONST D3DXQUATERNION * pQ1, CONST D3DXQUATERNION * pQ2, CONST D3DXQUATERNION * pQ3)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionSquadSetup"));
	original_D3DXQuaternionToAxisAngle = reinterpret_cast<void(WINAPI*)(CONST D3DXQUATERNION * pQ, D3DXVECTOR3 * pAxis, FLOAT * pAngle)>(GetProcAddress(g_d3dx9_module, "D3DXQuaternionToAxisAngle"));
	original_D3DXRectPatchSize = reinterpret_cast<HRESULT(WINAPI*)(CONST FLOAT * pfNumSegs, DWORD * pdwTriangles, DWORD * pdwVertices)>(GetProcAddress(g_d3dx9_module, "D3DXRectPatchSize"));
	original_D3DXSHAdd = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, UINT Order, CONST FLOAT * pA, CONST FLOAT * pB)>(GetProcAddress(g_d3dx9_module, "D3DXSHAdd"));
	original_D3DXSHDot = reinterpret_cast<FLOAT(WINAPI*)(UINT Order, CONST FLOAT * pA, CONST FLOAT * pB)>(GetProcAddress(g_d3dx9_module, "D3DXSHDot"));
	original_D3DXSHEvalConeLight = reinterpret_cast<HRESULT(WINAPI*)(UINT Order, CONST D3DXVECTOR3 * pDir, FLOAT Radius, FLOAT RIntensity, FLOAT GIntensity, FLOAT BIntensity, FLOAT * pROut, FLOAT * pGOut, FLOAT * pBOut)>(GetProcAddress(g_d3dx9_module, "D3DXSHEvalConeLight"));
	original_D3DXSHEvalDirection = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, UINT Order, CONST D3DXVECTOR3 * pDir)>(GetProcAddress(g_d3dx9_module, "D3DXSHEvalDirection"));
	original_D3DXSHEvalDirectionalLight = reinterpret_cast<HRESULT(WINAPI*)(UINT Order, CONST D3DXVECTOR3 * pDir, FLOAT RIntensity, FLOAT GIntensity, FLOAT BIntensity, FLOAT * pROut, FLOAT * pGOut, FLOAT * pBOut)>(GetProcAddress(g_d3dx9_module, "D3DXSHEvalDirectionalLight"));
	original_D3DXSHEvalHemisphereLight = reinterpret_cast<HRESULT(WINAPI*)(UINT Order, CONST D3DXVECTOR3 * pDir, D3DXCOLOR Top, D3DXCOLOR Bottom, FLOAT * pROut, FLOAT * pGOut, FLOAT * pBOut)>(GetProcAddress(g_d3dx9_module, "D3DXSHEvalHemisphereLight"));
	original_D3DXSHEvalSphericalLight = reinterpret_cast<HRESULT(WINAPI*)(UINT Order, CONST D3DXVECTOR3 * pPos, FLOAT Radius, FLOAT RIntensity, FLOAT GIntensity, FLOAT BIntensity, FLOAT * pROut, FLOAT * pGOut, FLOAT * pBOut)>(GetProcAddress(g_d3dx9_module, "D3DXSHEvalSphericalLight"));
	original_D3DXSHMultiply2 = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, CONST FLOAT * pF, CONST FLOAT * pG)>(GetProcAddress(g_d3dx9_module, "D3DXSHMultiply2"));
	original_D3DXSHMultiply3 = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, CONST FLOAT * pF, CONST FLOAT * pG)>(GetProcAddress(g_d3dx9_module, "D3DXSHMultiply3"));
	original_D3DXSHMultiply4 = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, CONST FLOAT * pF, CONST FLOAT * pG)>(GetProcAddress(g_d3dx9_module, "D3DXSHMultiply4"));
	original_D3DXSHMultiply5 = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, CONST FLOAT * pF, CONST FLOAT * pG)>(GetProcAddress(g_d3dx9_module, "D3DXSHMultiply5("));
	original_D3DXSHMultiply6 = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, CONST FLOAT * pF, CONST FLOAT * pG)>(GetProcAddress(g_d3dx9_module, "D3DXSHMultiply6("));
	original_D3DXSHPRTCompSplitMeshSC = reinterpret_cast<HRESULT(WINAPI*)(UINT * pClusterIDs, UINT NumVertices, UINT NumClusters, UINT * pSuperClusterIDs, UINT NumSuperClusters, LPVOID pInputIB, BOOL InputIBIs32Bit, UINT NumFaces, LPD3DXBUFFER * ppIBData, UINT * pIBDataLength, BOOL OutputIBIs32Bit, LPD3DXBUFFER * ppFaceRemap, LPD3DXBUFFER * ppVertData, UINT * pVertDataLength, UINT * pSCClusterList, D3DXSHPRTSPLITMESHCLUSTERDATA * pSCData)>(GetProcAddress(g_d3dx9_module, "D3DXSHPRTCompSplitMeshSC"));
	original_D3DXSHPRTCompSuperCluster = reinterpret_cast<HRESULT(WINAPI*)(UINT * pClusterIDs, LPD3DXMESH pScene, UINT MaxNumClusters, UINT NumClusters, UINT * pSuperClusterIDs, UINT * pNumSuperClusters)>(GetProcAddress(g_d3dx9_module, "D3DXSHPRTCompSuperCluster"));
	original_D3DXSHProjectCubeMap = reinterpret_cast<HRESULT(WINAPI*)(UINT uOrder, LPDIRECT3DCUBETEXTURE9 pCubeMap, FLOAT * pROut, FLOAT * pGOut, FLOAT * pBOut)>(GetProcAddress(g_d3dx9_module, "D3DXSHProjectCubeMap"));
	original_D3DXSHRotate = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, UINT Order, CONST D3DXMATRIX * pMatrix, CONST FLOAT * pIn)>(GetProcAddress(g_d3dx9_module, "D3DXSHRotate"));
	original_D3DXSHRotateZ = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, UINT Order, FLOAT Angle, CONST FLOAT * pIn)>(GetProcAddress(g_d3dx9_module, "D3DXSHRotateZ"));
	original_D3DXSHScale = reinterpret_cast<FLOAT*(WINAPI*)(FLOAT * pOut, UINT Order, CONST FLOAT * pIn, CONST FLOAT Scale)>(GetProcAddress(g_d3dx9_module, "D3DXSHScale"));
	original_D3DXSaveMeshHierarchyToFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR Filename, DWORD XFormat, CONST D3DXFRAME * pFrameRoot, LPD3DXANIMATIONCONTROLLER pAnimcontroller, LPD3DXSAVEUSERDATA pUserDataSaver)>(GetProcAddress(g_d3dx9_module, "D3DXSaveMeshHierarchyToFileA"));
	original_D3DXSaveMeshHierarchyToFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR Filename, DWORD XFormat, CONST D3DXFRAME * pFrameRoot, LPD3DXANIMATIONCONTROLLER pAnimController, LPD3DXSAVEUSERDATA pUserDataSaver)>(GetProcAddress(g_d3dx9_module, "D3DXSaveMeshHierarchyToFileW"));
	original_D3DXSaveMeshToXA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pFilename, LPD3DXMESH pMesh, CONST DWORD * pAdjacency, CONST D3DXMATERIAL * pMaterials, CONST D3DXEFFECTINSTANCE * pEffectInstances, DWORD NumMaterials, DWORD Format)>(GetProcAddress(g_d3dx9_module, "D3DXSaveMeshToXA"));
	original_D3DXSaveMeshToXW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pFilename, LPD3DXMESH pMesh, CONST DWORD * pAdjacency, CONST D3DXMATERIAL * pMaterials, CONST D3DXEFFECTINSTANCE * pEffectInstances, DWORD NumMaterials, DWORD Format)>(GetProcAddress(g_d3dx9_module, "D3DXSaveMeshToXW"));
	original_D3DXSavePRTBufferToFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pFileName, LPD3DXPRTBUFFER)>(GetProcAddress(g_d3dx9_module, "D3DXSavePRTBufferToFileA"));
	original_D3DXSavePRTBufferToFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pFileName, LPD3DXPRTBUFFER pBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXSavePRTBufferToFileW"));
	original_D3DXSavePRTCompBufferToFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pFileName, LPD3DXPRTCOMPBUFFER pBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXSavePRTCompBufferToFileA"));
	original_D3DXSavePRTCompBufferToFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pFileName, LPD3DXPRTCOMPBUFFER pBuffer)>(GetProcAddress(g_d3dx9_module, "D3DXSavePRTCompBufferToFileW"));
	original_D3DXSaveSurfaceToFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pDestFile, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DSURFACE9 pSrcSurface, CONST PALETTEENTRY * pSrcPalette, CONST RECT * pSrcRect)>(GetProcAddress(g_d3dx9_module, "D3DXSaveSurfaceToFileA"));
	original_D3DXSaveSurfaceToFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBUFFER * ppDestBuf, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DSURFACE9 pSrcSurface, CONST PALETTEENTRY * pSrcPalette, CONST RECT * pSrcRect)>(GetProcAddress(g_d3dx9_module, "D3DXSaveSurfaceToFileInMemory"));
	original_D3DXSaveSurfaceToFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pDestFile, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DSURFACE9 pSrcSurface, CONST PALETTEENTRY * pSrcPalette, CONST RECT * pSrcRect)>(GetProcAddress(g_d3dx9_module, "D3DXSaveSurfaceToFileW"));
	original_D3DXSaveTextureToFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pDestFile, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DBASETEXTURE9 pSrcTexture, CONST PALETTEENTRY * pSrcPalette)>(GetProcAddress(g_d3dx9_module, "D3DXSaveTextureToFileA"));
	original_D3DXSaveTextureToFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBUFFER * ppDestBuf, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DBASETEXTURE9 pSrcTexture, CONST PALETTEENTRY * pSrcPalette)>(GetProcAddress(g_d3dx9_module, "D3DXSaveTextureToFileInMemory"));
	original_D3DXSaveTextureToFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pDestFile, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DBASETEXTURE9 pSrcTexture, CONST PALETTEENTRY * pSrcPalette)>(GetProcAddress(g_d3dx9_module, "D3DXSaveTextureToFileW"));
	original_D3DXSaveVolumeToFileA = reinterpret_cast<HRESULT(WINAPI*)(LPCSTR pDestFile, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DVOLUME9 pSrcVolume, CONST PALETTEENTRY * pSrcPalette, CONST D3DBOX * pSrcBox)>(GetProcAddress(g_d3dx9_module, "D3DXSaveVolumeToFileA"));
	original_D3DXSaveVolumeToFileInMemory = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXBUFFER * ppDestBuf, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DVOLUME9 pSrcVolume, CONST PALETTEENTRY * pSrcPalette, CONST D3DBOX * pSrcBox)>(GetProcAddress(g_d3dx9_module, "D3DXSaveVolumeToFileInMemory"));
	original_D3DXSaveVolumeToFileW = reinterpret_cast<HRESULT(WINAPI*)(LPCWSTR pDestFile, D3DXIMAGE_FILEFORMAT DestFormat, LPDIRECT3DVOLUME9 pSrcVolume, CONST PALETTEENTRY * pSrcPalette, CONST D3DBOX * pSrcBox)>(GetProcAddress(g_d3dx9_module, "D3DXSaveVolumeToFileW"));
	original_D3DXSimplifyMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, CONST DWORD * pAdjacency, CONST D3DXATTRIBUTEWEIGHTS * pVertexAttributeWeights, CONST FLOAT * pVertexWeights, DWORD MinValue, DWORD Options, LPD3DXMESH * ppMesh)>(GetProcAddress(g_d3dx9_module, "D3DXSimplifyMesh"));
	original_D3DXSphereBoundProbe = reinterpret_cast<BOOL(WINAPI*)(CONST D3DXVECTOR3 * pCenter, FLOAT Radius, CONST D3DXVECTOR3 * pRayPosition, CONST D3DXVECTOR3 * pRayDirection)>(GetProcAddress(g_d3dx9_module, "D3DXSphereBoundProbe"));
	original_D3DXSplitMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMeshIn, CONST DWORD * pAdjacencyIn, CONST DWORD MaxSize, CONST DWORD Options, DWORD * pMeshesOut, LPD3DXBUFFER * ppMeshArrayOut, LPD3DXBUFFER * ppAdjacencyArrayOut, LPD3DXBUFFER * ppFaceRemapArrayOut, LPD3DXBUFFER * ppVertRemapArrayOut)>(GetProcAddress(g_d3dx9_module, "D3DXSplitMesh"));
	original_D3DXTessellateNPatches = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMeshIn, CONST DWORD * pAdjacencyIn, FLOAT NumSegs, BOOL QuadraticInterpNormals, LPD3DXMESH * ppMeshOut, LPD3DXBUFFER * ppAdjacencyOut)>(GetProcAddress(g_d3dx9_module, "D3DXTessellateNPatches"));
	original_D3DXTessellateRectPatch = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVERTEXBUFFER9 pVB, CONST FLOAT * pNumSegs, CONST D3DVERTEXELEMENT9 * pdwInDecl, CONST D3DRECTPATCH_INFO * pRectPatchInfo, LPD3DXMESH pMesh)>(GetProcAddress(g_d3dx9_module, "D3DXTessellateRectPatch"));
	original_D3DXTessellateTriPatch = reinterpret_cast<HRESULT(WINAPI*)(LPDIRECT3DVERTEXBUFFER9 pVB, CONST FLOAT * pNumSegs, CONST D3DVERTEXELEMENT9 * pInDecl, CONST D3DTRIPATCH_INFO * pTriPatchInfo, LPD3DXMESH pMesh)>(GetProcAddress(g_d3dx9_module, "D3DXTessellateTriPatch"));
	original_D3DXTriPatchSize = reinterpret_cast<HRESULT(WINAPI*)(CONST FLOAT * pfNumSegs, DWORD * pdwTriangles, DWORD * pdwVertices)>(GetProcAddress(g_d3dx9_module, "D3DXTriPatchSize"));
	// original_D3DXUVAtlasCreate = reinterpret_cast<HRESULT  (WINAPI*)(  LPD3DXMESH pMesh,   UINT uMaxChartNumber,   FLOAT fMaxStretch,   UINT uWidth,   UINT uHeight,   FLOAT fGutter,   DWORD dwTextureIndex,   CONST DWORD *pdwAdjacency,   CONST DWORD *pdwFalseEdgeAdjacency,   CONST FLOAT *pfIMTArray,   LPD3DXUVATLASCB pStatusCallback,   FLOAT fCallbackFrequency,   LPVOID pUserContext,   LPD3DXMESH *ppMeshOut,   LPD3DXBUFFER *ppFacePartitioning,   LPD3DXBUFFER *ppVertexRemapArray,   FLOAT *pfMaxStretchOut,   UINT *puNumChartsOut)>(GetProcAddress(g_d3dx9_module, "D3DXUVAtlasCreate"));
	// original_D3DXUVAtlasPack = reinterpret_cast<HRESULT  (WINAPI*)(  ID3DXMesh *pMesh, UINT uWidth,   UINT uHeight,   FLOAT fGutter,   DWORD dwTextureIndex,   CONST DWORD *pdwPartitionResultAdjacency,   LPD3DXUVATLASCB pStatusCallback,   FLOAT fCallbackFrequency,   LPVOID pUserContext,    LPD3DXBUFFER pFacePartitioning)>(GetProcAddress(g_d3dx9_module, "D3DXUVAtlasPack"));
	// original_D3DXUVAtlasPartition = reinterpret_cast<HRESULT  (WINAPI*)( LPD3DXMESH pMesh, UINT uMaxChartNumber, FLOAT fMaxStretch,  DWORD dwTextureIndex, 	CONST DWORD *pdwAdjacency, 	CONST DWORD *pdwFalseEdgeAdjacency, 	CONST FLOAT *pfIMTArray, 	LPD3DXUVATLASCB pStatusCallback, 	FLOAT fCallbackFrequency,	LPVOID pUserContext, LPD3DXMESH *ppMeshOut,  LPD3DXBUFFER *ppFacePartitioning,LPD3DXBUFFER *ppVertexRemapArray, LPD3DXBUFFER *ppPartitionResultAdjacency,  FLOAT *pfMaxStretchOut, UINT *puNumChartsOut)>(GetProcAddress(g_d3dx9_module, "D3DXUVAtlasPartition"));
	original_D3DXValidMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMeshIn, CONST DWORD * pAdjacency, LPD3DXBUFFER * ppErrorsAndWarnings)>(GetProcAddress(g_d3dx9_module, "D3DXValidMesh"));
	original_D3DXValidPatchMesh = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXPATCHMESH pMesh, DWORD * dwcDegenerateVertices, DWORD * dwcDegeneratePatches, LPD3DXBUFFER * ppErrorsAndWarnings)>(GetProcAddress(g_d3dx9_module, "D3DXValidPatchMesh("));
	original_D3DXVec2BaryCentric = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, CONST D3DXVECTOR2 * pV1, CONST D3DXVECTOR2 * pV2, CONST D3DXVECTOR2 * pV3, FLOAT f, FLOAT g)>(GetProcAddress(g_d3dx9_module, "D3DXVec2BaryCentric"));
	original_D3DXVec2CatmullRom = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, CONST D3DXVECTOR2 * pV0, CONST D3DXVECTOR2 * pV1, CONST D3DXVECTOR2 * pV2, CONST D3DXVECTOR2 * pV3, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXVec2CatmullRom"));
	original_D3DXVec2Hermite = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, CONST D3DXVECTOR2 * pV1, CONST D3DXVECTOR2 * pT1, CONST D3DXVECTOR2 * pV2, CONST D3DXVECTOR2 * pT2, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXVec2Hermite"));
	original_D3DXVec2Normalize = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, CONST D3DXVECTOR2 * pV)>(GetProcAddress(g_d3dx9_module, "D3DXVec2Normalize"));
	original_D3DXVec2Transform = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR2 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec2Transform"));
	original_D3DXVec2TransformArray = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, UINT OutStride, CONST D3DXVECTOR2 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec2TransformArray"));
	original_D3DXVec2TransformCoord = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, CONST D3DXVECTOR2 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec2TransformCoord"));
	original_D3DXVec2TransformCoordArray = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, UINT OutStride, CONST D3DXVECTOR2 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec2TransformCoordArray"));
	original_D3DXVec2TransformNormal = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, CONST D3DXVECTOR2 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec2TransformNormal"));
	original_D3DXVec2TransformNormalArray = reinterpret_cast<D3DXVECTOR2*(WINAPI*)(D3DXVECTOR2 * pOut, UINT OutStride, CONST D3DXVECTOR2 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec2TransformNormalArray"));
	original_D3DXVec3BaryCentric = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV1, CONST D3DXVECTOR3 * pV2, CONST D3DXVECTOR3 * pV3, FLOAT f, FLOAT g)>(GetProcAddress(g_d3dx9_module, "D3DXVec3BaryCentric"));
	original_D3DXVec3CatmullRom = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV0, CONST D3DXVECTOR3 * pV1, CONST D3DXVECTOR3 * pV2, CONST D3DXVECTOR3 * pV3, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXVec3CatmullRom"));
	original_D3DXVec3Hermite = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV1, CONST D3DXVECTOR3 * pT1, CONST D3DXVECTOR3 * pV2, CONST D3DXVECTOR3 * pT2, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXVec3Hermite"));
	original_D3DXVec3Normalize = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV)>(GetProcAddress(g_d3dx9_module, "D3DXVec3Normalize"));
	original_D3DXVec3Project = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV, CONST D3DVIEWPORT9 * pViewport, CONST D3DXMATRIX * pProjection, CONST D3DXMATRIX * pView, CONST D3DXMATRIX * pWorld)>(GetProcAddress(g_d3dx9_module, "D3DXVec3Project"));
	original_D3DXVec3ProjectArray = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, UINT OutStride, CONST D3DXVECTOR3 * pV, UINT VStride, CONST D3DVIEWPORT9 * pViewport, CONST D3DXMATRIX * pProjection, CONST D3DXMATRIX * pView, CONST D3DXMATRIX * pWorld, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec3ProjectArray"));
	original_D3DXVec3Transform = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR3 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec3Transform"));
	original_D3DXVec3TransformArray = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, UINT OutStride, CONST D3DXVECTOR3 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec3TransformArray"));
	original_D3DXVec3TransformCoord = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec3TransformCoord"));
	original_D3DXVec3TransformCoordArray = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, UINT OutStride, CONST D3DXVECTOR3 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec3TransformCoordArray"));
	original_D3DXVec3TransformNormal = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec3TransformNormal"));
	original_D3DXVec3TransformNormalArray = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, UINT OutStride, CONST D3DXVECTOR3 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec3TransformNormalArray"));
	original_D3DXVec3Unproject = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, CONST D3DXVECTOR3 * pV, CONST D3DVIEWPORT9 * pViewport, CONST D3DXMATRIX * pProjection, CONST D3DXMATRIX * pView, CONST D3DXMATRIX * pWorld)>(GetProcAddress(g_d3dx9_module, "D3DXVec3Unproject"));
	original_D3DXVec3UnprojectArray = reinterpret_cast<D3DXVECTOR3*(WINAPI*)(D3DXVECTOR3 * pOut, UINT OutStride, CONST D3DXVECTOR3 * pV, UINT VStride, CONST D3DVIEWPORT9 * pViewport, CONST D3DXMATRIX * pProjection, CONST D3DXMATRIX * pView, CONST D3DXMATRIX * pWorld, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec3UnprojectArray"));
	original_D3DXVec4BaryCentric = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR4 * pV1, CONST D3DXVECTOR4 * pV2, CONST D3DXVECTOR4 * pV3, FLOAT f, FLOAT g)>(GetProcAddress(g_d3dx9_module, "D3DXVec4BaryCentric"));
	original_D3DXVec4CatmullRom = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR4 * pV0, CONST D3DXVECTOR4 * pV1, CONST D3DXVECTOR4 * pV2, CONST D3DXVECTOR4 * pV3, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXVec4CatmullRom"));
	original_D3DXVec4Cross = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR4 * pV1, CONST D3DXVECTOR4 * pV2, CONST D3DXVECTOR4 * pV3)>(GetProcAddress(g_d3dx9_module, "D3DXVec4Cross"));
	original_D3DXVec4Hermite = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR4 * pV1, CONST D3DXVECTOR4 * pT1, CONST D3DXVECTOR4 * pV2, CONST D3DXVECTOR4 * pT2, FLOAT s)>(GetProcAddress(g_d3dx9_module, "D3DXVec4Hermite"));
	original_D3DXVec4Normalize = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR4 * pV)>(GetProcAddress(g_d3dx9_module, "D3DXVec4Normalize"));
	original_D3DXVec4Transform = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, CONST D3DXVECTOR4 * pV, CONST D3DXMATRIX * pM)>(GetProcAddress(g_d3dx9_module, "D3DXVec4Transform"));
	original_D3DXVec4TransformArray = reinterpret_cast<D3DXVECTOR4*(WINAPI*)(D3DXVECTOR4 * pOut, UINT OutStride, CONST D3DXVECTOR4 * pV, UINT VStride, CONST D3DXMATRIX * pM, UINT n)>(GetProcAddress(g_d3dx9_module, "D3DXVec4TransformArray"));
	original_D3DXWeldVertices = reinterpret_cast<HRESULT(WINAPI*)(LPD3DXMESH pMesh, DWORD Flags, CONST D3DXWELDEPSILONS * pEpsilons, CONST DWORD * pAdjacencyIn, DWORD * pAdjacencyOut, DWORD * pFaceRemap, LPD3DXBUFFER * ppVertexRemap)>(GetProcAddress(g_d3dx9_module, "D3DXWeldVertices"));
