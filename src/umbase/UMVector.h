...
namespace umbase
{
	...
	public:
		 ...
		 * constructor
		 */
		UMVector3(T a, T b, T c)
			: x(a), y(b), z(c) {}

		/**
		 * constructor
		 */
		UMVector3(const UMVector2<T>& v, T c)
			: x(v.x), y(v.y), z(c) {}

		/**
		 * copy constructor
		 */
		UMVector3(const UMVector3& v)
			: x(v.x), y(v.y), z(v.z) {}
	...
	public:
		 ...
		 * constructor
		 */
		UMVector4(T a, T b, T c, T d)
			: x(a), y(b), z(c), w(d) {}

		/**
		 * constructor
		 */
		UMVector4(const UMVector3<T>& v, T d)
			: x(v.x), y(v.y), z(v.z), w(d) {}

		/**
		 * copy constructor
		 */
		UMVector4(const UMVector4& v)
