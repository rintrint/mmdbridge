...
namespace umbase
{
	...
	public:
		...
		T determinant() const
		{
			...
			return (m[0][0] * m[1][1]) * (temp_a) - (m[0][0] * m[1][2]) * (temp_b) + (m[0][0] * m[1][3]) * (temp_c) - (m[0][1] * m[1][0]) * (temp_a) + (m[0][1] * m[1][2]) * (temp_d) - (m[0][1] * m[1][3]) * (temp_e) + (m[0][2] * m[1][0]) * (temp_b) - (m[0][2] * m[1][1]) * (temp_d) + (m[0][2] * m[1][3]) * (temp_f) - (m[0][3] * m[1][0]) * (temp_c) + (m[0][3] * m[1][1]) * (temp_e) - (m[0][3] * m[1][2]) * (temp_f);
		}
