...
typedef struct RenderData
{
	...
	RenderData()
	{
		...
		fvf = 0;
		pos = pos_xyz = pos_rhw = normal = psize = diffuse = specular = false;
...
{
	TextureParameter()
		: texture(NULL), hasTextureSampler0(FALSE), hasTextureSampler1(FALSE), hasTextureSampler2(FALSE), hasAlphaTexture(FALSE) {}
